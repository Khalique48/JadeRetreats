...
const CardHolder: React.FC<CardHolderProps> = ({ bgUrl, brand, logoUrl, event, stay }) => {
    return (
        <>
            <div
                className="h-[110vh] md:h-screen bg-cover bg-fixed bg-no-repeat md:px-2 px-30"
                style={{
            ...
            >
                <div className="bg-gradient-to-t from-black to-transparent md:bg-backgroundColor bg-opacity-50 flex md:flex-row flex-col justify-end items-end md:items-center transition duration-300 opacity-100 px-0 md:px-4 h-full w-full">
                    <div className="ease-in duration-100 md:bg-customColor md:w-[35%] w-full px-5 bg-backgroundColor text-white rounded-[5px] shadow-lg md:border-2 md:border-borderColor flex flex-col items-center transition pb-4 md:mt-20 md:mb-20 mt-[100vh]">
                        <div className="container mx-auto flex flex-col items-left my-0">
                            ...
                            <div className="bg-borderBackground hidden md:flex justify-center items-start flex-col border-2 rounded border-textBackground gap-y-3 p-3">
                                <h2 className="text-sm mb-0 px-0 tracking-widest">BEST SUITED FOR</h2>
                            ...
                            <div className="text-left flex justify-around items-center pt-0 my-4">
                                <h2 className="md:block hidden text-sm mb-2">Customize Your Experience</h2>
                            ...
                            <div className="flex justify-around lowercase items-center gap-x-3 my-4 px-2">
                                <div className="text-center text-[0.5rem] bg-textColor py-2 px-4">
                                    Hall for Gatherings </div>
                                <div className="text-center text-[0.5rem] bg-textColor py-2 px-4">
                                    Large Elegant Lawn
                                </div>
                                <div className="text-center text-[0.5rem] bg-textColor py-2 px-4">
                            ...
                            <div className="text-center">
                                <Link
                                    ...
                                    className="block bg-custom-gradient text-black py-2 px-4 rounded-md  transition-colors duration-300 font-semibold"
                                >
                                    VIEW RETREAT
                                </Link>
                            </div>
